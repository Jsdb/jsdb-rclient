...
describe('RDb3Client >', function () {
    ...
    describe('Higher layer >', function () {
        ...
        describe('Local cache >', function () {
            ...
            it('Should send null value for sub non existing value early', function () {
                root.handleChange('/node', null, dummyProg++);
            ...
            it('Should send null value for sub of non existing value after', function () {
                var ref = root.getUrl('/node/sub/sub');
                var snap;
                var cb = ref.on('value', function (data) { return snap = data; });
                root.handleChange('/node', null, dummyProg++);
            ...
            it('Should send null value non existing value early', function () {
            ...
            it('Should send null value of non existing value after', function () {
                var ref = root.getUrl('/node/sub/sub');
                var snap;
                var cb = ref.on('value', function (data) { return snap = data; });
                root.handleChange('/node/sub/sub', null, dummyProg++);
